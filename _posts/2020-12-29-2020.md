...
At the same time, however, I'm starting to question if Optimizing for Learning should always be the top priority. There are other good outputs - such as impact to the world or personal benefit - and this year, I made decisions that put them below learning. I wonder if that's always going to be the right choice: When does the time come to put Execution above Learning, or Investment below Payoff?

The phrase "I'm still learning!" is dangerous, because it sounds so virtuous. I'll always be able to put myself in places where I'll be learning. So the question becomes: When, if ever, should I stop considering learning to be so virtuous?
...
On one hand, many things didn't changed. The number of new, meaningful friendships I made was probably <10% of the number the year before. I'm ending the year in a similar place to where I started it: Haven't moved to California yet. Haven't figured out a permanent living situation. Haven't become an "adult".
...
* Almost co-founding a startup (March - May) - building a prototype, evaluating a seed investment + cofounders. Ultimately chose not to; that's another essay.
* Full-time work at a startup - my first job! (June - December) - evolving strategy and product definition, experiencing tactics of a growing company, doing product work for the first time
* Airbnb hopping in Utah, Colorado, and Washington (July - December)

# Ten general things I learned this year

These aren't super unique insights, and many are things I already knew. But this year hammered them home.
...
### 2. Narratives are irrationally important. They also don't need to correlate with reality.
...
### 5. Who you know > what you know - but it's not that simple.
...
Others have argued this better than me, so I'll just cite my [favorite book touching the topic](https://www.amazon.com/Mythical-Man-Month-Software-Engineering-Anniversary/dp/0201835959).
...
### 9. Invest in what you like to do now, instead of what you think will pay off later.
...
When choosing between two things to learn, don't worry about what has better payoff. Instead, pick what you enjoy more.
...
Without getting into details, I likely spent 10% of this year agonizing over personal and career decisions. But looking back, I worried about the decision before I made it. I haven't spent a second thinking about them afterwards.
...
# Places I lived for five or more days this year

Not that meaningful, but interesting - I moved around a lot. Each could be an essay.
...
# What I'm prioritizing for 2021
